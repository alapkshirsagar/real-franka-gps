...
protected:
  ...
  boost::shared_ptr<KDL::ChainFkSolverPos> passive_arm_fk_solver_,
        active_arm_fk_solver_;
  // KDL solvers for end-effector Jacobians.
  boost::shared_ptr<KDL::ChainJntToJacSolver> passive_arm_jac_solver_,
...
public:
  ...
  virtual void trial_subscriber_callback(const
  ...
  virtual void data_request_subscriber_callback(const
      gps_agent_pkg::DataRequest::ConstPtr& msg);
  //tf callback
  virtual void tf_robot_action_command_callback(const
  ...
  virtual void get_joint_encoder_readings(Eigen::VectorXd &angles,
                                          gps::ActuatorType arm) const = 0;
  // Get forward kinematics solver.
  virtual void get_fk_solver(boost::shared_ptr<KDL::ChainFkSolverPos> &fk_solver,
                             boost::shared_ptr<KDL::ChainJntToJacSolver> &jac_solver, gps::ActuatorType arm);
