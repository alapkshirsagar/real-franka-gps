...
class optitrack_publisher:
    ...
    def publish_optitrack_data(self):
        try:
            ...
            trans_human = [0,0,0]
            trans_human[0] = trans_human_orig[1]- 0.118 + 0.25
            trans_human[1] = -trans_human_orig[0]
            trans_human[2] = trans_human_orig[2]+ 0.185 -0.13
            # print(trans_robot)
            # print(self.trans_human[self.timestep,0])
            trans_human[0] = trans_human[0] - trans_robot[0]    #for RELATIVE-moving targets
            trans_human[1] = trans_human[1] - trans_robot[1]    #for RELATIVE-moving targets
            trans_human[2] = trans_human[2] - trans_robot[2]    #for RELATIVE-moving targets
