...
SENSOR_DIMS = {
    ...
    JOINT_VELOCITIES: 9,
    END_EFFECTOR_POINTS: 9, #3 for robot eef, 3 for human hand, 3 for object
...
EXP_DIR = BASE_DIR + '/../experiments/real_franka_badmm_sim2real_9/'
...
for i in xrange(common['conditions']):
    ...
    x0[:9] = [-0.000159,-0.783775,0.000139,-2.356250,0.000304,1.570931,0.784746, 0.04, 0.04]
    x0[18:(18+3*EE_POINTS.shape[0])] = np.ndarray.flatten(
...
agent = {
    ...
    'x0': np.concatenate([np.array([-0.000159,-0.783775,0.000139,-2.356250,0.000304,1.570931,0.784746, 0.04,0.04 ]),
    ...
    'test': False,
    'reduced': 'NoHumanJoints',#FullState, NoHumanJoints, RelativeEEF
