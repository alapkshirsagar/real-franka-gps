"""
This file defines utilities for the ROS control agents.
It differs from the original in using latching on the command publisher.
"""
import numpy as np
...
class ServiceEmulator(object):
    ...
    def __init__(self, pub_topic, pub_type, sub_topic, sub_type):
        self._pub = rospy.Publisher(pub_topic, pub_type, latch = True, queue_size = 10)
